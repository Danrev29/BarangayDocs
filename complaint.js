  ...
  complaintForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, "complaints"), {
        ...
        address: address,
        message: message,
        imageURL: imageURL || "", // if you have image uploads
        email: auth.currentUser.email, // ✅ add this!
      ...
      try {
        await emailjs.send("service_3scnxqg", "template_zf1pgjc", {
          name: name,
          address: address,
          message: message,
      ...
      console.error("❌ Failed to submit complaint or send email:", err);
